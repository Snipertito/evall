...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/#عمك روبت يكسمك/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1603288696,1491711183,1900794631,2122266503,99990000999}   
...
if text == "/start" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'خالد') 
local DRAGON_Msg = { 
...
os.execute('wget https://raw.githubusercontent.com/#عمك روبت يكسمك/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' 🔥 اصدار سورس خالد{ S:12✓}')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'خالد').." غادر" or text == 'غادر' then  
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "خالد")
...
if text == 'قناه الاستوري' or text == 'استوري الخالد' or text == 'قناه الاستوريهات' or text == 'استوري ليجاند' then 
local Text = [[ 
...
if text == 'المطور خالد' or text == 'خالد' or text == 'الخول' then
local Text = [[
[المطور خالد لو حبب تتواصل معاه اتبع الزر اللي تحت](t.me/L_o_s_e_f_i_r)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹L O S E F I R ˼',url="t.me/L_o_s_e_f_i_r"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/L_o_s_e_f_i_r&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
[ليل مطور السورس](t.me/L_e_i_L1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹L E I L˼',url="t.me/L_e_i_L1"}},
{{text = 'اضف البوت الي مجموعتك 🔥 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨ بوت اليوتيوب ❤️ ❩',url="t.me/L_o_s_e_f_i_r_1_bot"},{text = '❨ بوت تيك توك 🖤 ❩',url="t.me/K0XBOT"}},
...
if text == 'العاب خالد' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then    
local Text = [[  
 🔥 اهلا في قائمه الالعاب المتطوره سورس خالد 🔥 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/sourcelosefir&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(99990000999) then  
...
if result.id_ == tonumber(99990000999) then
...
if tonumber(userid) == tonumber(99990000999) then  
send(msg.chat_id_, msg.id_, " 🔥 لا تسطيع حظر مطور السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/#عمك روبت يكسمك/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🔥 اهلا بك في متجر ملفات خالد\n 🔥 ملفات السورس ↓\n━━━━━↝𝑳𝑶𝑺𝑬𝑭𝑰𝑹↜━━━━━\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/#عمك روبت يكسمك/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 🔥 عذرا الملف لايدعم سورس خالد\n") 
end
return false
end
...
if text == ("مسح قائمه خالد") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🔥 تم مسح قائمه خالد')
return false
end

if text == 'قائمه خالد' and Sudo(msg) then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'خالد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'خالد')
local DRAGON_Msg = {
'نعم يروحي 😻🌚',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس خالديعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'خالد').." الاحصائيات" or text == 'الاحصائيات' then  
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' 🔥 الاحصائيات  \n'..' 🔥 عدد الجروبات  ↚ {'..Groups..'}'..'\n 🔥  عدد المشتركين  ↚ {'..Users..'}'
...
if tonumber(msg.sender_user_id_) == tonumber(2122266503) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المالك خالد نن عيني 🥺🤍](t.me/sourcelosefir)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if tonumber(msg.sender_user_id_) == tonumber(1603288696) then
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'G A S S E R',url="t.me/gesoO9"},{text = 'L O S E F I R', url="t.me/L_o_s_e_f_i_r"}},
{{text = 'L E I L',url="t.me/L_e_i_L1"},{text = 'T A W A S O L', url="t.me/L_o_c_e_f_i_r_pro_bot"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ L E G E N D ˼',url="t.me/L120N"}},
{{text = '˹ T A W O S L ˼ ',url="t.me/LEGANND_BOT"}}, 
{{text = ' ˹B A C K ˼', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'خالد')
