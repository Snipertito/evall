...
-------------------------------------------------------------------------------------------------------------
if (text == 'تفعيل' or text == '/start@kitty12_bot' or text == '/start@USDDBOT') and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/FA9SH/156&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'مؤمن' or text == 'المبرمج شادو' or text == 'مبرمج السورس' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
if text == 'فمبير' or text == 'مالك السورس' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
if text == 'بار شادو' or text == 'كوكب شادو' or text == بار المبرمج شادو' or text == 'متيجي' or text == 'متيقي' then
local Text = [[
متيقي هنا بق بار المبرمج شادو هتلاقيني هناك تع نورني
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑩𝑨𝑹 𝑺𝑯𝑨𝑫𝑶𝑾🏂💖',url="t.me/farfasha6"}},
{{text = 'اضف البوت الي مجموعتك 🦅 ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاستر').." كفشتدطغ" or text == 'كفشتدطغ' then  
...
send(msg.chat_id_,msg.id_, '[بيعرج..😹💔🎶](t.me/FA9SH)')
return false
end
...
{{text = '˹T W S L˼ ',url="t.me/usddshad"}}, 
{{text = ' ˹B A C K ˼', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
