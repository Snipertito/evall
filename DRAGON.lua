...
keyboard.inline_keyboard = { 
{{text = '˹𝐂𝐇 𝐅𝐀𝐒𝐓𝐄𝐑˼ ', url="t.me/FA9SH"}},
{{text = 'اضف البوت الى مجموعتك 🦅 ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='تم اختيار لو خيروك بالصور لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹𝐂𝐇 𝐅𝐀𝐒𝐓𝐄𝐑˼ ', url="t.me/FA9SH"}},
{{text = 'اضف البوت الى مجموعتك 🦅 ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
...
if text == 'المبرمج شادو' or text == 'مبرمج السورس' or text == 'مين عملك السورس' or text == 'مؤمن' then
local Text = [[
...
{{text = 'اضف البوت الى مجموعتك 🦅' ,url="t.me/"..dofile("./DRAGON.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
🦅 روايات ← لعرض الميزه
🦅 ثيم ← لعرض الميزه
🦅 رمزيات ولاد← لعرض الميزه
🦅 رمزيات بنات← لعرض الميزه
🦅 رمزيات كابلز← لعرض الميزه
🦅 معني + اسمك ← لعرض الميزه
🦅 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
🦅 𝘾𝙃 - [˹𝐅𝐀𝐒𝐓𝐄𝐑˼](t.me/FA9SH) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'تيتو')
local DRAGON_Msg = { 
