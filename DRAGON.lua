...
sudo_users = {SUDO,1603288696,2122266503,2093265110,2131266597}   
...
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور اساسي²" 
elseif tonumber(user_id) == tonumber(2131266597) then
var = 'تونز شادو🌝💗'
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅 العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..') \n 🦅 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'شادو' or text == 'المبرمج شادو' or text == 'مبرمج السورس' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 1603288696,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1603288696, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == 'فامبير' or text == 'مطور السورس' or text == 'مطور السورس' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
if text == 'سيزر' or text == 'مالك السورس' or text == 'عبده اصيل' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 2122266503,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 2122266503, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🦅 العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'V_I_K_I_N_G2')..')'..'\n 🦅 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if tonumber(msg.sender_user_id_) == tonumber(2131266597) then
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[تونز المبرمج شادو🌝💗](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[انتي تونز المبرمج شادو روح قلبي🌝💗](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/V_I_K_I_N_G2)') 
return false
end
...
if text == "تيست"  or text == "التيست" then
...
if text == 'بت' then
send(msg.chat_id_,msg.id_, '[ليا اسم ياض يعره يمهزء نينينينني😹😎🏃🏻‍♀](t.me/V_I_K_I_N_G2)')
return false
end
...
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه', callback_data="/help1"},{text = 'اوامر التسليه', callback_data="/help7"},
},
{
