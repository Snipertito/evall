...
sudo_users = {SUDO,968613145,1603288696,1227722692}   
...
if text == 'تربو مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج تربو لو حابب تتواصل معاه
اتبع الزر إلى تحت ⩹━━━⊶SＯＵＲСＥ EＶＡＬ⊷━━━⩺↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖣘 TURBO 𖣘', url="t.me/UU_T_U_R_B_O"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if AddChannel(msg.sender_user_id_) == false then
local SourceEval = database :get(bot_id ..'text:ch:user')
if SourceEval then
send(msg.chat_id_, msg.id_,'['..SourceEval..']')
else
send(msg.chat_id_, msg.id_,' ◍  لا تستطيع استخدام البوت \n  ◍  يرجى الاشتراك بالقناه اولا \n  ◍  اشترك هنا ['..database :get(bot_id ..'add:ch:username')..']')
end
return false
...
{{text = 'ᏟᎻ ᎬᏙᎪᏞ', url="t.me/SourceEval"},{text = 'ͲᎳՏΌᏞ', url="t.me/xx_xxppabot"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩𝙏 𝙄𝙏 𝙊𓆪',url="t.me/e2_c11"},{text = '𖣘 TURBO 𖣘', url="t.me/UU_T_U_R_B_O"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- كلـؤ حـس بـ آللآمآن ف ؤقـت غيـآبي .',url="t.me/Xccpp"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'جليتش مبرمج السورس',url="t.me/Xccpp"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ', url="t.me/e2_c12bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/evalllllllll/33&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
