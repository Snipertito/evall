...
if text == 'روبت' or text == 'يوسف روبت' or text == 'يوسف' then
local Text = [[  عع مك روبت يبنلوسخةة
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᖇOᗷOT', url="t.me/S_A5_D"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/45&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'عموره'  then
local Text = [[
عموره مبرمج السورس³ لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'عمؤره ٲلهقر❤️',url="t.me/BOT3mora"}},
}
local msg_id = msg.id_/2097152/0.5
